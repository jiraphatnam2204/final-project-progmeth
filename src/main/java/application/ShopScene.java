...
import logic.item.weapon.IronSword;
import logic.item.weapon.PlatinumSword;
import logic.item.weapon.StoneSword;
...
public class ShopScene {
    ...
    private void buildInventory() {
        items.add(new ShopItem(
                ...
                p -> {
                    p.addItem(new SmallHealthPotion(), 1);
                }
        ));
        items.add(new ShopItem(
                "Medium Potion", "Heals 50 HP", 80, Color.web("#c62828"),
                p -> {
                    p.addItem(new MediumHealthPotion(), 1);
                }
        ));
        items.add(new ShopItem(
                "Big Potion", "Heals 100 HP", 120, Color.web("#b71c1c"),
                p -> {
                    p.addItem(new BigHealthPotion(), 1);
                }
        ));
